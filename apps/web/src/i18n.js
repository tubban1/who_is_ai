...
export const TRANSLATIONS = {
  ...
  en: {
    ...
    genderMale: 'Gentleman',
    genderFemale: 'Lady',
    maleHint: 'Trench Coat Guy',
    femaleHint: 'Chic Pleated Skirt',
    styleTrench: 'Trench Look',
    styleSkirt: 'Skirt Look',
    youBadge: 'YOU',
    ...
    impostorEyebrow: 'IMPOSTOR STATS',
    impostorLeaderboardTitle: 'Master Impostor Board',
    impostorSubhead: 'Who is best at pretending to be AI to deceive human detectives?',
    colDeceptionRate: 'Deception Rate',
    colDeceivedCount: 'Deceptions / Tested',
    badgeImpostor: '🎭 Neural Impostor',
    noImpostors: 'No impostor records yet. Get tested by other humans while acting like an AI!',
    impostorFootNote: 'Deception Rate: When tested by other players, the percentage they mistakenly voted "AI" or "Not Sure".',
  ...
  ja: {
    ...
    impostorEyebrow: '偽装統計',
    impostorLeaderboardTitle: '偽装マスターランキング',
    impostorSubhead: 'AIのふりをして他の人間の探偵を最も欺いたのは誰か？',
    colDeceptionRate: '欺瞞率',
    colDeceivedCount: '欺瞞成功/被テスト',
    badgeImpostor: '🎭 偽装の達人',
    noImpostors: '偽装データがまだありません。AIになりきって他のプレイヤーを欺きましょう！',
    impostorFootNote: '欺瞞率：他のプレイヤーからテストされた際、相手が「AI」または「保留」と誤認した割合。',
  ...
  de: {
    ...
    genderLabel: 'Charakter-Geschlecht',
    genderMale: 'Herr',
    genderFemale: 'Dame',
    maleHint: 'Trenchcoat-Gentleman',
    femaleHint: 'Chice Dame im Faltenrock',
    styleTrench: 'Trenchcoat',
    styleSkirt: 'Faltenrock',
    youBadge: 'DU',
    ...
    impostorEyebrow: 'TÄUSCHUNGS-STATISTIK',
    impostorLeaderboardTitle: 'Meister-Hochstapler-Rangliste',
    impostorSubhead: 'Wer kann am besten eine KI vortäuschen und Detektive narren?',
    colDeceptionRate: 'Täuschungsquote',
    colDeceivedCount: 'Getäuscht / Getestet',
    badgeImpostor: '🎭 Meister der Täuschung',
    noImpostors: 'Noch keine Daten vorhanden. Spiele wie eine KI, um andere zu täuschen!',
    impostorFootNote: 'Täuschungsquote: Prozentsatz, mit dem andere Spieler dich fälschlicherweise für eine KI oder unsicher hielten.',
  ...
  fr: {
    ...
    genderLabel: 'Genre & Avatar',
    genderMale: 'Homme',
    genderFemale: 'Femme',
    maleHint: 'Jeune homme en trench',
    femaleHint: 'Femme chic en jupe plissée',
    styleTrench: 'Style Trench',
    styleSkirt: 'Style Jupe',
    youBadge: 'VOUS',
    ...
    impostorEyebrow: 'STATISTIQUES D\'IMPOSTURE',
    impostorLeaderboardTitle: 'Tableau des Maîtres Imposteurs',
    impostorSubhead: 'Qui réussit le mieux à imiter une IA pour duper les détectives ?',
    colDeceptionRate: 'Taux de tromperie',
    colDeceivedCount: 'Trompés / Testés',
    badgeImpostor: '🎭 Maître Imposteur',
    noImpostors: 'Aucune donnée d\'imposteur pour le moment. Jouez le rôle d\'une IA pour tromper les autres !',
    impostorFootNote: 'Taux de tromperie : pourcentage des joueurs vous ayant testé qui ont cru à tort que vous étiez une IA ou n\'étaient pas sûrs.',
  ...
  es: {
    ...
    genderLabel: 'Género y Avatar',
    genderMale: 'Caballero',
    genderFemale: 'Dama',
    maleHint: 'Joven con gabardina',
    femaleHint: 'Dama chic con falda tableada',
    styleTrench: 'Gabardina',
    styleSkirt: 'Falda tableada',
    youBadge: 'TÚ',
    ...
    impostorEyebrow: 'ESTADÍSTICAS DE IMPOSTOR',
    impostorLeaderboardTitle: 'Tabla de Maestros Impostores',
    impostorSubhead: '¿Quién es el mejor fingiendo ser una IA para engañar a los detectives humanos?',
    colDeceptionRate: 'Tasa de engaño',
    colDeceivedCount: 'Engañados / Evaluados',
    badgeImpostor: '🎭 Maestro Impostor',
    noImpostors: 'Aún no hay registros. ¡Hazte pasar por IA cuando otros te evalúen!',
    impostorFootNote: 'Tasa de engaño: Porcentaje de jugadores que te evaluaron y creyeron erróneamente que eras IA o quedaron inseguros.',
